        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(group, inx) in spuSaleAttrList" :key="inx">
                <dt class="title">{{ group.saleAttrName }}</dt>
                <dd
                  v-for="(attr, inx) in group.spuSaleAttrValueList"
                  :key="attr.id"
                  changepirce="40"
                  :class="{ active: parseInt(attr.isChecked) }"
                  @click="changeActive(attr, group.spuSaleAttrValueList)"
                >
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getDetailInfo", this.$route.params.skuid); //派发action，请求数据
  },
  ...
  methods: {
    changeActive(attr, attrlist) {
      ...
      attr.isChecked = attr.isChecked == "1" ? "0" : "1";
    },
    changeSkuNum(event) {
